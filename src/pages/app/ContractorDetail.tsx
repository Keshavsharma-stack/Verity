...
export function ContractorDetail() {
  ...
  const handleTriggerAI = async (docId: string) => {
    ...
    const res = await aiDocumentService.processDocumentExtraction(user.workspaceId, id, docId);
                        ...
                        <div className="flex gap-3.5 items-start">
                          ...
                          <div>
                            <div className="flex items-center gap-2">
                              ...
                              {procStatus === 'VERIFIED' && (
                                <span className="inline-flex items-center gap-1 text-[10px] font-bold text-emerald-400 bg-emerald-950/80 border border-emerald-800/60 px-1.5 py-0.5 rounded">
                              ...
                              {procStatus === 'FAILED' && (
                                <span className="inline-flex items-center gap-1 text-[10px] font-bold text-red-400 bg-red-950/80 border border-red-800/60 px-1.5 py-0.5 rounded">
                                  <XCircle className="w-3 h-3" /> AI Failed
                                </span>
                              )}
                            </div>
              ...
              {loadingExtraction ? (
                ...
                <>
                  ...
                  {inspectingExtraction?.requirementChecks && inspectingExtraction.requirementChecks.length > 0 && (
                    <div>
                      <h3 className="text-xs font-bold uppercase tracking-wider text-zinc-300 mb-2">Compliance Requirement Matching</h3>
