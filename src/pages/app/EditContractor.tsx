...
export function EditContractor() {
  ...
  return (
    <div className="max-w-3xl mx-auto space-y-6">
      ...
      <div>
        <h1 className="text-2xl font-bold text-white tracking-tight">Edit Contractor Profile</h1>
      ...
      <form onSubmit={handleSubmit}>
        <Card className="bg-[#0a0a0f] border-zinc-800/80 shadow-2xl">
          ...
          <CardHeader className="border-t border-zinc-800/80 bg-zinc-950/60">
            <CardTitle className="text-sm font-bold text-zinc-200">Required Compliance Passports</CardTitle>
          </CardHeader>
